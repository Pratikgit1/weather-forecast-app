        ...
        <div className="content" key={data.dt}>
            <div className="hourly-metrics">
              ...
              <div className="title-first smaller">
                {convertToCelcius(data.main.temp_min)} &deg;C / {convertToCelcius(data.main.temp_max)} &deg;C
            ...
            <div className="title-footer">
              ...
              <div>
                ...
                <div>
                  Wind speed {_.round(data.wind.speed * 3.6, 1)} kmph at {data.wind.deg}&deg; angle
                </div>
                {
                  data.rain && <div>
                  Rainfall last 3 hours {data.rain["3h"]} mm
                </div>
                }
                <div>
